...
public class StudentProfilePresenter implements StudentProfileOutputBoundary {
    ...
    public StudentProfilePresenter(ViewManagerModel viewManagerModel,
                                   StudentProfileViewModel studentProfileViewModel, StudentHomeViewModel studentHomeViewModel) {
